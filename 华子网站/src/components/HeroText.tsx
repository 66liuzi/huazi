...
export default function HeroText() {
  ...
  return (
    ...
    >
      <motion.p
        variants={item}
        className="text-sm tracking-[0.3em] uppercase text-cyan-400/80 mb-6"
      >
      ...
      <motion.h1
        variants={item}
        className="text-6xl md:text-8xl lg:text-9xl font-medium tracking-tight mb-6 font-[family-name:var(--font-cinzel)]"
      >
      ...
      <motion.div variants={item} className="mt-10 pt-6">
        <button
          ...
          className="relative inline-flex items-center justify-center gap-5 px-[280px] py-[64px] rounded-full
                     text-white font-semibold text-lg tracking-[0.25em]
        ...
        >
          <span className="relative z-10 whitespace-nowrap">查看作品集</span>
