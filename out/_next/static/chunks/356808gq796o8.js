(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,20887,e=>{"use strict";var t=e.i(43476),a=e.i(71645),o=e.i(21663),n=e.i(53604),i=e.i(56850),l=e.i(80075);let r=({height:e=3.5,baseWidth:r=5.5,animationType:s="rotate",glow:u=1,offset:c={x:0,y:0},noise:m=.5,transparent:f=!0,scale:h=3.6,hueShift:v=0,colorFrequency:d=1,hoverStrength:b=2,inertia:x=.05,bloom:p=1,suspendWhenOffscreen:w=!1,timeScale:g=.5})=>{let M=(0,a.useRef)(null);return(0,a.useEffect)(()=>{let t=M.current;if(!t)return;let a=Math.max(.001,e),y=.5*Math.max(.001,r),S=Math.max(0,u),E=Math.max(0,m),B=c?.x??0,H=c?.y??0,C=Math.max(.001,h),P=Math.max(0,d||1),T=Math.max(0,p||1),R=Math.max(0,g||1),A=Math.max(0,b||1),F=Math.max(0,Math.min(1,x||.12)),I=Math.min(2,window.devicePixelRatio||1),L=new o.Renderer({dpr:I,alpha:f,antialias:!1}),j=L.gl;j.disable(j.DEPTH_TEST),j.disable(j.CULL_FACE),j.disable(j.BLEND),Object.assign(j.canvas.style,{position:"absolute",inset:"0",width:"100%",height:"100%",display:"block"}),t.appendChild(j.canvas);let q=`
